    ...
    UserDataMigrationRepositoryProtocol
{
    ...
    private func consumableItemData(_ value: ConsumableItem) -> [String: Any] {
        ...
        [
            ...
            "reduceBaselineDailyAmount": value.reduceBaselineDailyAmount as Any,
            "reduceBaselineCostPerConsume": decimalToNumber(value.reduceBaselineCostPerConsume) as Any,
